...
class AppWidgetTime : AppWidgetProvider() {
    ...
    private fun shiftShow(context: Context) {
        ...
        //按钮绑定函数
        val intent_up = Intent(context, AppWidgetTime::class.java)
        ...
        val intent_down = Intent(context, AppWidgetTime::class.java)
        ...
        val componentName = ComponentName(context, AppWidgetTime::class.java)
